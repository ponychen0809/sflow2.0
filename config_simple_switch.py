...
p4.pipe.MyIngress.port_sampling_rate.add_with_set_sampling_rate(ingress_port=140, sampling_rate=99)

p4.pipe.MyIngress.port_sampling_rate.add_with_set_sampling_rate(ingress_port=143, sampling_rate=49)
